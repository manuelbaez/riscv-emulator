/opt/riscv/bin/riscv64-unknown-linux-gnu-gcc -Wl,-Ttext=0x0 -nostdlib -o ./test-files/add-addi.elf ./test-files/add-addi.s
...
/opt/riscv/bin/riscv64-unknown-linux-gnu-gcc -Bstatic -nodefaultlibs -nostdlib -Qn -O0 -Ttext=0x0 ./test-files/app.c -o ./test-files/app.elf
